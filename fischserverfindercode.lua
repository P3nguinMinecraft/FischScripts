-- data collection for ancient orca???!?
...
local formattedData = table.concat(data, "\n")
local embed = {
    embeds = {
        {
            title = "Zones Found!",
...
local embedData = game:GetService("HttpService"):JSONEncode(embed)
request({
    Url = "https://discord.com/api/webhooks/1335657103939076196/6enVzNVGkLEFo0ypvLJH7KrXuSYbnYvpsYXADIoT_5BzHfZ9x0R5DeDwIumpap5LQoOy",
    Method = "POST",
